...
void readIMUTask(void *pvParameters) {
    while (true) {
        ...
        vTaskDelay(100 / portTICK_PERIOD_MS); // Read data every 100 ms
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Task to send data over Wi-Fi
...
void setup() {
    ...
    xTaskCreate(readIMUTask, "ReadIMU", 2048, NULL, 1, NULL);
...
void loop() {
    ...
    //         if(xAxis >= 1790){
    //             xAxis = map(analogRead(analogXPin), 1790, 4095, 0, -50);
    //         }else if(xAxis <= 1750){
    //             xAxis = map(analogRead(analogXPin), 1750, 0, 0, 50);
    //         }else{
    //             xAxis = 0;
    //         }
    ...
    //         if(yAxis >= 1850){
    //             yAxis = map(analogRead(analogYPin), 1790, 4095, 0, -50);
    //         }else if(yAxis <= 1810){
    //             yAxis = map(analogRead(analogYPin), 1750, 0, 0, 50);
    //         }else{
    //             yAxis = 0;
    //         }
